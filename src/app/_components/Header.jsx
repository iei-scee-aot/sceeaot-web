...
const Header = () => {
  return (
    <header className="w-[calc(100%-30px)] lg:w-[calc(100%-200px)] h-auto lg:h-[4.5625rem] border-[0.5px] border-t-0 border-b-0 border-gray-500 flex justify-between items-center mx-auto px-3 lg:px-6">

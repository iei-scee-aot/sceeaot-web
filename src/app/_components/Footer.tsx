...
const Footer = () => {
  return (
    <>
      <footer className="mx-auto w-[calc(100%-30px)] lg:w-[calc(100%-200px)] border-gray-500 border-l-[0.5px] border-r-[0.5px]">
          <div className="py-6 px-6 md:px-32 border-t border-[#747474]/30">
            ...
            <div className=" flex flex-col ">
              ...
              <Link
              href="/contact"
              className="flex md:mt-2 md:text-9xl lg:text-[9rem] items-center justify-center text-center mx-auto text-[3rem] font-light font-pxg group"
            >
              Contact us
              <ArrowUpRight
                size={50}

...
const Navbar = () => {
  return (
    <>
        <nav className="fixed w-screen bottom-0 left-1/2 transform -translate-x-1/2  bg-[#0e0c0c] border-t border-[#747474]/30 z-50 p-4 flex justify-between items-center">
        <Link
          href="/"

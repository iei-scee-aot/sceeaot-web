...
const Navbar = ({homeColor="#F6F6F4", teamColor="#F6F6F4", eventColor="#F6F6F4", aboutColor="#F6F6F4"}) => {
  return (
    <>
      <nav className="lg:hidden fixed font-pxg w-screen bottom-0 bg-[#0e0c0c] border-t-[0.5px] border-gray-500 z-50  flex flex-col">
      ...
      <nav className="hidden border-b-[0.5px] font-pxg w-screen bg-[#0e0c0c] border-gray-500 z-50 lg:flex flex-col sticky top-0">

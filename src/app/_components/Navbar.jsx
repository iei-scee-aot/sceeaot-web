...
const Navbar = ({homeColor="#F6F6F4", teamColor="#F6F6F4", eventColor="#F6F6F4", aboutColor="#F6F6F4"}) => {
  return (
    <>
      <nav className="lg:hidden fixed font-pxg w-full bottom-0 bg-[#0e0c0c] border-t-[0.5px] border-gray-500 z-50  flex flex-col">
        ...
        <div className=" w-full py-3 border-gray-500 border-t-[0.5px]"></div>
      </nav>

	...
	},
	{
		...
		members: [
			...
			},
			{
				Name: "Esha Guha",
				Designation: "Member",
				imagePath: "/_pictures/Esha_Guha.jpg",
				links: [],
			},
			{
			...
			},
			{
				Name: "Koushani Kundu",
				Designation: "Member",
				imagePath: "/_pictures/Koushani_Kundu.jpg",
				links: [],
			},
		],
	},
	{
		title: "PR & Marketing Team",
		members: [
			{
...
const Page = () => {
	...
	return (
		<>
			<div className="h-full border-gray-500 border-b-[0.5px] w-full mb-4 pb-8 lg:pb-0 font-pxg">
				<Divider />
				<Header />
				<Divider2 />
				...
				{teamSections.map((section) => (
					<React.Fragment key={section.title}>
						<div className="w-[calc(100%-30px)] lg:w-[calc(100%-200px)] mx-auto border-[0.5px] border-gray-500 border-t-0 border-b-0 ">
							<div className="flex items-center border-gray-500 border-b-[0.5px] overflow-hidden ">
								<Headlines headLine={section.title} />
							</div>
							<div className="flex flex-wrap gap-y-8 md:gap-y-12 justify-evenly md:gap-x-9 gap-x-3 md:px-9 px-3 items-stretch py-8">

...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen bg-background text-secondary flex flex-col items-center justify-center px-4">
      {/* Animated 404 */}
      <div
      ...
      >
        ...
        <p className="text-base md:text-lg lg:text-xl mb-8 text-secondary/80 font-pxg leading-relaxed">
          ...
          digital void. It might have been moved, deleted, or perhaps it never
          existed at all.
        </p>
      </div>
      {/* Navigation Buttons */}
      ...
      >
        <p className="text-sm text-secondary/60 font-pxg">
          Lost? Don't worry, even the best engineers sometimes take wrong turns.
        </p>
      </div>
    </div>
  );

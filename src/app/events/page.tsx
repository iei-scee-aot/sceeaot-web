      ...
      */}
      <main className="relative flex flex-col w-[25rem] mx-auto min-h-screen bg-[#0e0c0c] text-white font-sans pb-32 overflow-x-hidden">
        ...
        <div className="p-4">
          ...
          <div className="mb-6 border border-[#747474]/30 rounded-sm overflow-hidden bg-[#000000]">
            <div className="relative">
              <Image
                src="/pujo_pixel.png"
                alt="PUJO PIXEL Event"
                width={340}
                height={445}
                className="w-full h-auto"
              />
              <div className="absolute bottom-4 right-4 bg-[#fec20c] text-black py-2 px-4 flex items-center gap-2 font-semibold hover:bg-[#fec20c]/90 transition-all duration-300">
                VIEW GALLERY
            ...
            <div className="p-4">
              <div className="flex justify-between items-center mb-2">
                <h3 className="text-xl font-bold">PUJO PIXEL</h3>
              ...
              <div className="grid grid-cols-2 gap-2 mb-4 text-sm">
                ...
                <div className="flex justify-between border-b border-[#747474] py-1">
                  ...
                  <span className="text-[#fec20c]">Online</span>
                </div>
                <div className="flex justify-between border-b border-[#747474] py-1">
                  <span className="text-[#747474]">Registration Fees</span>
                  <span className="text-[#fec20c]">Free</span>
                </div>
                <div className="flex justify-between border-b border-[#747474] py-1">
                  <span className="text-[#747474]">Team Size</span>
                  <span className="text-[#fec20c]">Solo</span>
                </div>
              </div>

              <p className="text-sm text-[#f6f6f4]">
                A completely virtual photography event organized by IEI
                Students’ Chapter EE to celebrate Durga Puja. It was based on
                three themes all participate can take part in all or any one.
                Winner of each theme was awarded with a cash prize of ₹200.
              </p>
            </div>
          </div>
          ...
          <div className="mb-6 border border-[#747474]/30 rounded-sm overflow-hidden bg-[#000000]">
            ...
            <div className="p-4">
              <div className="flex justify-between items-center mb-2">
                <h3 className="text-xl font-bold">IOTRICITY</h3>
                <span className="text-xs bg-[#f63538] px-2 py-1 rounded-full">
                  Closed
                </span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 mb-4 text-sm">
                <div className="flex justify-between border-b border-[#747474] py-1">
                  <span className="text-[#747474]">Date</span>
                  <span className="text-[#fec20c]">
                    14th, 15th, 17th August 2024
                  </span>
                </div>
                <div className="flex justify-between border-b border-[#747474] py-1">
                  <span className="text-[#747474]">Mode</span>
                  <span className="text-[#fec20c]">Offline</span>
                </div>
                <div className="flex justify-between border-b border-[#747474] py-1">
                  <span className="text-[#747474]">Registration Fees</span>
                  <span className="text-[#fec20c]">₹50</span>
                </div>
                <div className="flex justify-between border-b border-[#747474] py-1">
                  <span className="text-[#747474]">Team Size</span>
                  <span className="text-[#fec20c]">3-5 members</span>
                </div>
              </div>

              <p className="text-sm text-[#f6f6f4]">
                A hardware ideathon event ,first of it’s kind to be held in the
          ...
          <div className="mb-6 border border-[#747474]/30 rounded-sm overflow-hidden bg-[#000000]">
            <div className="relative">
              <Image
                src="/Electroforge.png"
                alt="ELECTROFORGE Event"
                width={400}
                height={200}
                className="w-full h-auto"
              />
            ...
            <div className="p-4">
              <div className="flex justify-between items-center mb-2">
                <h3 className="text-xl font-bold">ELECTROFORGE</h3>
                <span className="text-xs bg-[#f63538] px-2 py-1 rounded-full">
                  Closed
                </span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 mb-4 text-sm">
                <div className="flex justify-between border-b border-[#747474] py-1">
                  <span className="text-[#747474]">Date</span>
                  <span className="text-[#fec20c]">23rd March 2024</span>
                </div>
                <div className="flex justify-between border-b border-[#747474] py-1">
                  <span className="text-[#747474]">Mode</span>
                  <span className="text-[#fec20c]">Offline</span>
              ...
              <p className="text-sm text-[#f6f6f4]">
                An invited talk and hands-on-workshop was organized on printed
